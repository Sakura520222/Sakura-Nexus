...
> 创建：2026-08-29 · 当前状态：**六项核心架构决策已拍板并落盘，待第七问（范围分级）**
...
- [x] 阶段0.5 核心架构决策：六项 ADR 拍板并分类落盘（docs/decisions/）
- [ ] 阶段1 **第七问：范围分级（P0/P1/P2 切分）**——待用户拍板
- [ ] 阶段2 总体设计文档：架构总图、MySQL schema（含 gotd session 存储方案）、.env v2 清单、部署设计（compose/systemd + Qdrant）
- [ ] 阶段3 实施计划（Go 版，待范围分级后编写）
- [ ] 阶段4+ 按计划实施（**每次跨入实施前需用户确认**）
